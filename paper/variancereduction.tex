...
%The extra $i$ subscript is to make sure we agree with the notation adopted below, where we repeat the $N_k$ draw many times, and each draw is indexed with $i$.
